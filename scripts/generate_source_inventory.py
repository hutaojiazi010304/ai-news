...
ROWS = [
    ...
    ("内置·精选媒体", "新智元", "aiera.com.cn",
     "https://aiera.com.cn/feed/", "RSS（WordPress）",
     "最多 15 条；每天早晨批量发布当日中文 AI 新闻；2026-08-31 重叠率 0%（accept_default）接入"),
    ...
    # ---------------- 已评估未接入 ----------------
    ("已评估未接入", "机器之心", "jiqizhixin.com",
     "无可用公开端点", "—（未接入）",
     "2026-08-31 评估：整站改为付费数据服务落地页，/rss 与文章页均返回广告页；仅付费数据服务或微信桥接可选"),
